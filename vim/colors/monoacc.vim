...
hi Normal ctermfg=31 ctermbg=235 cterm=NONE
hi link pythonDoctest   Normal

" Python specific

hi pythonComment ctermfg=215 ctermbg=NONE cterm=italic

hi pythonStatement ctermfg=14 ctermbg=NONE cterm=bold
...
hi pythonFunction ctermfg=162 ctermbg=NONE cterm=NONE
